...
var filePath = @"C:\temp\fix_session.summary";
...
SaveCSV(timeBuckets, @"C:\temp\output.csv");

Dictionary<string, int> GetTimeBucketsDictionary()
{
...
void SaveCSV(Dictionary<string, int> dict, string outputFilePath)
{
